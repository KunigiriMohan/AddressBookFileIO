...
class AddressBookMain {
    ...
    private static ArrayList<Contact> fileentry = new ArrayList<>();
    ...
    public void printContactFileDetails() {
        AdressBookFileIO addressBookFileIO= new AdressBookFileIO();
    ...
    public static void menu() {
        ...
        System.out.println("Press 12 to enter into file");
        System.out.println("Press 13 to show details in file");
...
/*
* writeAddressBookInFiles() method to write data into file
* */
    public void writeAddressBookInFiles() {
        new AdressBookFileIO().writeData(fileentry);
        ...
        while (choice != 14) {
            if (choice == 1) {
                ...
                if (obj.person.containsKey(fName) == true)            //Checking contact is present in the Address book or not
                {
                    ...
                    obj.fileentry.add(new Contact(fName, lName, number, city, state, pinCode));
                }
                ...
                } else
                {
                    ...
                    obj.stateName.put(city, new Contact(fName, lName, number, city, state, pinCode));
                    obj.fileentry.add(new Contact(fName, lName, number, city, state, pinCode));
                    obj.writeAddressBookInFiles();
                }
            }
            else if(choice == 13){
                obj.printContactFileDetails();
            }
